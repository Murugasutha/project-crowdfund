...
function Footer() {
    return ( 
        <footer className="footer mt-auto mt-auto py-4 bg-success">
            <Container className="text-light">
                <Row>
                    <Col md={3} sm={6} className="mb-3 text-center">
                        <h5 className="fw-bold">CrowdFunding</h5>
                        <p>Your trusted platform to raise funds for what matters most.</p>
                    </Col>
                    <Col md={3} sm={6} className="mb-3 text-center">
                        <ul className="list-unstyle ">
                            <h6 className="fw-semibold ">Quick Links</h6>
                            <li><a className="text-light" href="/">Home</a></li>
                            <li><a className="text-light" href="/campaigns">Campaigns</a></li>
                            <li><a className="text-light" href="/about">About</a></li>
                            <li><a className="text-light" href="/signup">Login / Signup</a></li>
                        </ul>
                    </Col>
                    <Col md={3} sm={6} className="mb-3 text-center">
                        <ul className="list-unstyle ">
                            ...
                            <li><a className="text-light" href="">Terms and Conditions</a></li>
                        </ul>
                    </Col>
                    <Col md={3} sm={6} className="mb-3 text-center">
                            <h6 className="fw-semibold ">Quick Links</h6>
                ...
                <hr />
                <p className="text-center mb-0 small">&copy; {new Date().getFullYear()} CrowdFunding. All rights reserved.</p>
            </Container>
        </footer>
     );
}
